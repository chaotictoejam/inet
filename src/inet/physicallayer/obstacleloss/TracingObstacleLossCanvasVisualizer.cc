...
#include "inet/physicallayer/obstacleloss/TracingObstacleLossCanvasVisualizer.h"
...
void TracingObstacleLossCanvasVisualizer::initialize(int stage)
{
    ...
    if (stage == INITSTAGE_LOCAL) {
        obstacleLoss = getModuleFromPar<TracingObstacleLoss>(par("obstacleLossModule"), this);
